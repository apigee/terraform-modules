...
module "appliance-sa" {
  source     = "github.com/terraform-google-modules/cloud-foundation-fabric//modules/iam-service-account?ref=v9.0.2"
  project_id = var.project_id
  name       = "sa-${var.name}"
}

module "config-bucket" {
  source     = "github.com/terraform-google-modules/cloud-foundation-fabric//modules/gcs?ref=v9.0.2"
  project_id = var.project_id
