...
variable "firewall_appliance_zone" {
  description = "GCP Compute Zone for the mocked egress firewall appliance."
  type        = string
}

variable "firewall_appliance_tags" {
  description = "Network Tags for the mocked egress firewall appliance."
  type        = list(string)
  default     = ["egress-fw"]
}

variable "firewall_appliance_subnet" {
  description = "Subnet for the mocked egress firewall appliance."
  type = object({
    name               = string
